 ...
 * - toolExclusions: [String] (tool names to exclude even if tools includes "*")
...
export class MongoEntityStore {
     ...
     * @param {string[]} [entity.toolExclusions] - Tool exclusions list
    ...
    async upsertEntity(entity) {
        ...
        try {
            ...
            const doc = {
                ...
                tools: entity.tools || ['*'],
                toolExclusions: entity.toolExclusions || [],
