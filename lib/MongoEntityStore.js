 ...
 * - modelPolicy: Object (optional - stage-specific models for runtime operation)
...
export class MongoEntityStore {
     ...
     * @param {Object} [entity.modelPolicy] - Stage-specific model selection
    ...
    async upsertEntity(entity) {
        ...
        try {
            ...
            const doc = {
                ...
                modelPolicy: entity.modelPolicy || null, // Optional: stage-specific model policy
