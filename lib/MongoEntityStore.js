...
export class MongoEntityStore {
     ...
     * @param {Object} [entity.voice] - Voice profile { provider, voiceId, voiceName, settings }
    ...
    async upsertEntity(entity) {
        ...
        try {
            ...
            const doc = {
                ...
                voice: entity.voice || null, // Optional: { provider, voiceId, voiceName, settings: {stability, similarity, style, speakerBoost} }
                tools: entity.tools || ['*'],
