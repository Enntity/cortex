...
export class MongoEntityStore {
    ...
    /**
     * Sync the internal cache to config.entityConfig
     * This ensures loadEntityConfig() in sys_entity_tools.js gets fresh data
    ...
    async getEntity(entityId, options = {}) {
        ...
        try {
            ...
            if (entity) {
                ...
                // Sync config cache so loadEntityConfig() gets fresh data
                this._syncConfigCache();
                return entityData;
            }
    ...
    async getAllEntities(options = {}) {
        ...
        try {
            ...
            if (userId) {
                ...
                // For non-system entities, include public (empty/missing) or user-associated
                query.$or = [
    ...
    async addUserToEntity(entityId, userId) {
        ...
        try {
            ...
            const entityConfig = config.getProperties().entityConfig;
            if (entityConfig && entityConfig[entityId]) {
    ...
    async upsertEntity(entity) {
        ...
        try {
            ...
            // Sync config.entityConfig so loadEntityConfig() gets fresh data
            this._syncConfigCache();
    ...
    async deleteEntity(entityId) {
        ...
        try {
            ...
            // Remove from cache and sync config
