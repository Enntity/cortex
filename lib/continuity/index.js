 ...
 * - AzureMemoryIndex: Long-term semantic memory (Azure AI Search backend)
 ...
 * 
 * Backend Selection:
 * - Set CONTINUITY_MEMORY_BACKEND=mongo or CONTINUITY_MEMORY_BACKEND=azure
 * - Or auto-detects: uses MongoDB if MONGO_URI is set, otherwise Azure
 * 
 * Integration:
