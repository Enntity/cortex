...
export class ContextBuilder {
    ...
    buildContextWindow({
        ...
        // 9. Session Context (Duration, temporal awareness)
    ...
    _buildExpressionSection(expressionState) {
        ...
        if (expressionState.lastInteractionTimestamp) {
            ...
            const now = new Date();
            let totalSeconds = Math.floor((now - lastInteraction) / 1000);
            ...
            parts.push(`Last spoke: ${timeParts.join(', ')} ago`);
        }
    ...
    _buildInternalCompassSection(internalCompass) {
        ...
        // The compass content is already formatted with Vibe/Recent Story/Open Loops/My Note
